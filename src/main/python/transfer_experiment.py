...
class TransferExperiment(object):
    ...
    def run_parameter_relaxation(self, cc_rate, p_rate, ppq_rate):
        ...
        print self.name, self.poly_degree, "Optimal cc:", optimal_cc, " p ", optimal_p, "ppq", self.optimal_point.x[2], "Thr:", optimal_throughput_revised
        ...
        for relaxed_cc in range(optimal_cc-1, 0, -1):
            ...
            #print "cc", relaxed_cc, throughput, prev_thr, (prev_thr-throughput)
            prev_thr = throughput
